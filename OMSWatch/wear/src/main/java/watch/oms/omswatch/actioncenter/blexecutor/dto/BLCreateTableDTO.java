...
/**
 * @author 245742 Declares the variables required for BLCreate
 * 
 */
public class BLCreateTableDTO {

	public List<BLTableColumnDTO> columnDTOList;
	public BLTableDBDTO dbDto;
	public BLTableCreateTableDTO dbtableDTO;
}
