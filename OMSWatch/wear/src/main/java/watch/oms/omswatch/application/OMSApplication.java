...
//	}
    ...
    public String getConfigDataAPIURL() {
        return configDataAPIURL;
    }

    public void setConfigDataAPIURL(String configDataAPIURL) {
        this.configDataAPIURL = configDataAPIURL;
    }

    public String getConfigDataAPIResponse() {
        return configDataAPIResponse;
    }
	...
	public void setTransDataAPIURL(String transDataAPIURL) {
		this.transDataAPIURL = transDataAPIURL;
	}

	public String getTransDataAPIResponse() {
		return transDataAPIResponse;
	}
