...
public class PostAsyncTaskHelper extends AsyncTask<String, Void, String> {
	...
	public PostAsyncTaskHelper(Context c, String clientTableName, JSONObject JSONPayLoadList,
			String uniqueId, OMSReceiveListener receiveListener, int appId,String loadMessage) {
		this.context = c;
